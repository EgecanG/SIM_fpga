...
class Receiver():
    def __init__(self, axi_dma, receiver, inspector):
        ...
        def on_signal_change(change):
            shape = ((2048, ), (2048, ), (2048, ), (2048, ), (2048, ))
            freq = (128000000, 128000000, 128000000, 128000000, 128000000)
        ...
        self._s_sel = DropdownMenu([('Received Signal', 0),
                                    ('Time Synchronisation', 1),
                                    ('Symbols', 2),
                                    ('Symbol/Error Count', 3),
                                    ('BER/SER (WIP)', 4)],
                                    'Observation Point:',
                                    1)
        ...
        self.controller.receive_size = 32
