...
from Py_scripts import clocks

class FSKOverlay(Overlay):
    ...
    def __init__(self, bitfile_name=None, init_rf_clks=True, run_test=True, debug_test=False, **kwargs):
        ...
        self.radio_receiver = Receiver(self.axi_dma_rx, self.fsk4_rx_0, self.DataInspectorRx)
        
        # Receiver setup requirements - pull resets low
        self.radio_receiver.controller.threshold = 0x1790
        self.radio_receiver.controller.freq_offset = int(3)
        ...
        self.radio_transmitter = Transmitter(self.axi_dma_tx, self.fsk4_hf_pulse_0, self.DataInspectorTx)
