...
class Transmitter():
    def __init__(self, axi_dma, transmitter, inspector):
        ...
        def on_signal_change(change):
            ...
            freq = (128000000, 128000000, 128000000)
        ...
        self.monitor = AsyncRadioTx(rate=0.5, timer_callback=self._transfer)
...
class TransmitterCore(DefaultIP):
    ...
    bindto = ['UoS:RFSoC:fsk4_hf_pulse:1.0']
